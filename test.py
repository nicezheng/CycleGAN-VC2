    ...
    def validation_for_A_dir(self):
        ...
        for file in os.listdir(validation_A_dir):
            ...
            wav_transformed = preprocess.world_speech_synthesis(f0=f0_converted,
                                                                ...
                                                                fs=sampling_rate,
                                                                frame_period=frame_period)
            sf.write(os.path.join(output_A_dir, os.path.basename(file)),wav_transformed,sampling_rate)
    ...
    def validation_for_B_dir(self):
        ...
        for file in os.listdir(validation_B_dir):
            ...
            wav_transformed = preprocess.world_speech_synthesis(f0=f0_converted,
                                                                ...
                                                                fs=sampling_rate,
                                                                frame_period=frame_period)
            sf.write(os.path.join(output_B_dir, os.path.basename(file)), wav_transformed, sampling_rate)
...
if __name__ == '__main__':
    ...
    validation_A_dir_default = './data/test_jz/'
    output_A_dir_default = './converted_sound/test_jz/'

    validation_B_dir_default = './data/test_jay/'
    output_B_dir_default = './converted_sound/test_jay/'
